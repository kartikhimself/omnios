...
public class PreviousIcon extends WhiteIcon {
    ...
    protected void draw(Canvas canvas) {
        ...
        mPath1.reset();
        mPath1.moveTo(0.8f * width, 0);
        mPath1.lineTo(0.9f * width, height);
        mPath1.lineTo(0.1f * width, 0.4f * height);
        mPath1.lineTo(0.8f * width, 0);

        mPath2.reset();
        mPath2.moveTo(0.8f * width, 0);
        mPath2.lineTo(0.1f * width, 0.4f * height);
        mPath2.lineTo(0.39f * width, 0.65f * height);
        mPath2.lineTo(0.8f * width, 0);

        mPath3.reset();
        mPath3.moveTo(0.8f * width, 0);
        mPath3.lineTo(0.1f * width, 0.4f * height);
        mPath3.lineTo(0.85f * width, 0.5f * height);
        mPath3.lineTo(0.8f * width, 0);

        mPath4.reset();
        mPath4.moveTo(0, 0);
        mPath4.lineTo(0.2f * width, 0);
        mPath4.lineTo(0.2f * width, height);
        mPath4.lineTo(0, height);
        mPath4.lineTo(0, 0);
